  ...
  return (
    <div className='relative grid gap-10'>
      <section className='pt-5'>
        ...
        pattern-size-32 pattern-opacity-10 md:h-full absolute left-0 top-[-150px]'>
        </div>
